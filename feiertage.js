module.exports = function(RED) {
    function feiertage(config) {
        ...
        berchtoldstag[2] = Feiertage.getBerchtoldstag(Feiertage.formatDateObj, currentYear);
        berchtoldstag[3] = Feiertage.getBerchtoldstag(Feiertage.formatDE, currentYear);
        ...
        bundesfeierCH[2] = Feiertage.getBundesfeierCH(Feiertage.formatDateObj, currentYear);
        bundesfeierCH[3] = Feiertage.getBundesfeierCH(Feiertage.formatDE, currentYear);
        ...
        function refreshHoliday() {
            ...
            if ((new Date(berchtoldstag[2]) - new Date(currentYear + "-" + currentMonth + "-" + currentDay)) < 0) {
                berchtoldstag[2] = Feiertage.getBerchtoldstag(Feiertage.formatDateObj, currentYear + 1);
                berchtoldstag[3] = Feiertage.getBerchtoldstag(Feiertage.formatDE, currentYear + 1);
            }
            ...
            if ((new Date(bundesfeierCH[2]) - new Date(currentYear + "-" + currentMonth + "-" + currentDay)) < 0) {
                bundesfeierCH[2] = Feiertage.getBundesfeierCH(Feiertage.formatDateObj, currentYear + 1);
                bundesfeierCH[3] = Feiertage.getBundesfeierCH(Feiertage.formatDE, currentYear + 1);
            }
